...
import com.example.read_app.ui.font.FontsActivity;
import com.example.read_app.util.BrightUtil;
import com.example.read_app.util.DateHelper;
...
//                    mReadActivity.getLvContent().setSelection(position);
    ...
    private void initReadViewOnClick() {
        ...
        mReadContentAdapter.setmOnLongClickItemListener(new ReadContentAdapter.OnLongClickItemListener() {
            @Override
            public void onClick(View view, int positon) {
                Log.e("sdfdsf",positon+"  "+pointY);
            }
        });
