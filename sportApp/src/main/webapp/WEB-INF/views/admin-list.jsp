...
<html class="x-admin-sm">
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            <button class="layui-btn" onclick="xadmin.open('添加用户','../User/ZhongZhuan?key=admin-add',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                        <div class="layui-card-body ">
    ...
    <script>
        ...
        layui.use('table',function(){
            ...
            table.render({
                elem:'#mytable',
                url:'http://localhost:8080/sportApp/User/getAdmins',
                page:true,
                limit:5,
                id:"adminid",
                cols:[[
                    {field: 'adminid',title:"ID",width:200},
                    {field: 'username',title:"登录名",width:200},
                    {field: 'phone',title:"手机",width:200},
                    {field: 'email',title:"邮箱",width:200},
                    {field: 'pass',title:"密码",width:200},
            ...
            table.on('tool(ctuae)', function(obj){
               ...
               if(obj.event === 'del'){
                    layer.confirm('确定删除吗', function(index){
                        $.ajax({
                            type: 'get',
                            url: 'http://localhost:8080/sportApp/User/deleteAdmin?adminid='+data.adminid,
                   ...
                   xadmin.open('编辑','../User/ZhongZhuanId?key=admin-edit&adminid='+data.adminid+"&classtable=admin");
