            ...
            <div class="layui-row">
                <form class="layui-form">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="miaoshu" name="miaoshu" required="" lay-verify="miaoshu"
                          autocomplete="off" class="layui-input">
                      </div>
                  </div>
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                         <button type="button" class="btn btn-primary" id="chooseFile">选择视频</button>
                  ...
                  <div class="layui-form-item">
                      <label for="nicheng" class="layui-form-label">
                          <span class="x-red">*</span>昵称
                      </label>
                      <div class="layui-input-inline">
                          <input type="text" id="nicheng" name="nicheng" required="" lay-verify=""
                          autocomplete="off" class="layui-input">
                      </div>
                  </div>
                     <div class="layui-form-item">
                      <label for="useraccount" class="layui-form-label">
                          <span class="x-red">*</span>你的平台帐号
                      </label>
                      <div class="layui-input-inline">
                          <input type="text" id="useraccount" name="useraccount" required="" lay-verify=""
                          autocomplete="off" class="layui-input">
                      </div>
                  </div>
                  <div class="layui-form-item">
        ...
        var uploadListIns;
            ...
            function() {
                ...
                uploadListIns = upload.render({
                    ...
                    url: 'http://localhost:8080/sportApp/testquestion/addShiPing',   //后台处理文件长传的方法
                    data:{'title':function(){
                        return $("#title").val();
                    },'miaoshu':function(){
                        return $("#miaoshu").val();
