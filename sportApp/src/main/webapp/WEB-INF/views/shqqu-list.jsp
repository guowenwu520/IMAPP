...
<html class="x-admin-sm">
    ...
    <script>
        ...
        layui.use('table',function(){
            ...
            table.render({
                elem:'#mytable',
                url:'http://localhost:8080/sportApp/village/getVillage',
                page:true,
                limit:5,
                id:"adminid",
                cols:[[
                    {field: 'id',title:"ID",width:200},
                    {field: 'title',title:"社区名",width:200},
                    {field: 'villageDesc',title:"描述",width:200},
                    {field: 'district',title:"语言",width:200},
            ...
            table.on('tool(ctuae)', function(obj){
               ...
               if(obj.event === 'del'){
                    layer.confirm('确定删除吗', function(index){
                        $.ajax({
                            type: 'get',
                            url: 'http://localhost:8080/sportApp/village/deletevillage?id='+data.id,
                   ...
                   xadmin.open('编辑','../User/ZhongZhuanId?key=village-edit&adminid='+data.id+"&classtable=village");
